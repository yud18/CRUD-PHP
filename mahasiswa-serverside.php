...
if ($_GET['action'] == "table_data") {
    ...
    if (empty($_POST['search']['value'])) {
        ...
        //jika tidak ada pencarian maka dia akan membaca kode dibawah ini
    ...
    if (!empty($query)) {
        ...
        while ($value = $query->fetch_array()) {
            ...
            $nestedData['aksi'] = '<div style="display: flex; justify-content: space-between; width: 70%;">
                        <a href="detail-mahasiswa.php?id_mahasiswa='.$value['id_mahasiswa'].'" class="btn btn-warning"><i class="fas fa-info-circle"></i> Detail</a>
                        <a href="ubah-mahasiswa.php?id_mahasiswa='.$value['id_mahasiswa'].'" class="btn btn-success"><i class="fas fa-edit"></i> Ubah</a>
                        <a href="hapus-mahasiswa.php?id_mahasiswa='.$value['id_mahasiswa'].'" class="btn btn-danger" onclick="return confirm(\'Yakin Ingin Hapus Data ini?\')"><i class="fas fa-trash-alt"></i> Hapus</a>
                      </div>';
